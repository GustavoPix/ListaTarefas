        ...
        <div class="tarefas">
            <div class="task_lists">
                <ul>
                    <li class="task" v-for="(task,i) in filteredTasks()">
                        <div>
                            ...
                            <div class="name">
                                ...
                                <input type="text" v-else v-model="task.name" v-on:keyup.enter="saveUpdateNome(task)">
                            </div>
                            <div class="icons">
                                <ul>
                    ...
                    <li class="newTask">
                        <input type="text" placeholder="Nova Tarefa..." v-model="newTask" v-on:keyup.enter="addTaskButton()">
                    </li>
                </ul>
            </div>
        </div>
        <div class="about" v-if="aboutOpen" @click.self.prevent="aboutOpen = false">
            <div class="conteudo">
                <div class="row">
                    <div class="close" @click="aboutOpen = false">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12L19 6.41L17.59 5Z" fill="#CCCCD4"/>
                        </svg>
                    </div>
                </div>
                <div class="section">
                ...
                <div class="section">
                    <h3>Site</h3>
                    <p><a href="https://gustavo-carvalho.com" target="_blank">https://gustavo-carvalho.com</a></p>
                </div>
            </div>
        </div>
    </div>
